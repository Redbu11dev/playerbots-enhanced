...
{   
    ...
    public:
        ...
        void loadAreaLevels();
        std::unordered_map<uint32, std::vector<QuestGiverTravelDestination*>> getQuestGiverTravelDestinations() { return questGiversDestinations; }
        std::unordered_map<uint32, std::vector<QuestObjectiveTravelDestination*>> getQuestObjectiveTravelDestinations() { return questObjectivesDestinations; }
        std::unordered_map<uint32, std::vector<QuestTakerTravelDestination*>> getQuestTakerTravelDestinations() { return questTakersDestinations; }
    ...
    protected:
        ...
        std::unordered_map<uint32, std::vector<QuestGiverTravelDestination*>> questGiversDestinations;
        std::unordered_map<uint32, std::vector<QuestObjectiveTravelDestination*>> questObjectivesDestinations;
        std::unordered_map<uint32, std::vector<QuestTakerTravelDestination*>> questTakersDestinations;
    ...
    public:
        ...
        std::unordered_set<uint32> m_allBattlegroundQuestIds = {
            7385,
            7362,
            7081,
            8080,
