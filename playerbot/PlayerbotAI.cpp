...
std::list<Creature*> PlayerbotAI::GetAllCreaturesAround(float distanceAround)
{
    CreatureList targets;

    MaNGOS::AnyUnitInObjectRangeCheck u_check(bot, distanceAround);
    MaNGOS::CreatureListSearcher<MaNGOS::AnyUnitInObjectRangeCheck> searcher(targets, u_check);
    Cell::VisitAllObjects(bot, searcher, distanceAround);
