...
bool TravelTarget::isTraveling() {
    ...
    {
        setTarget(sTravelMgr.nullTravelDestination, new WorldPosition(bot->GetPositionX(), bot->GetPositionY(), bot->GetPositionZ()), true);
        return false;
    }
...
void TravelMgr::setNullTravelTarget(Player* player)
{
    ...
    if (target)
        target->setTarget(sTravelMgr.nullTravelDestination, new WorldPosition(player->GetPositionX(), player->GetPositionY(), player->GetPositionZ()), true);
}
